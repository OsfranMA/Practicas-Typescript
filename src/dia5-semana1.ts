...
function verificarNivelAcceso(id: string | number, esAdmin: boolean = false): string {
...
function calcularPromedioCalificaciones(calificacion: number[]): number  {
...
function mostrarAlertaSistema(mensaje: string, codigo?: number): void {
    if (codigo !== undefined) {
